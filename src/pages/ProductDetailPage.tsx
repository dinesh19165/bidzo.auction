          ...
          <div className="grid gap-3 md:grid-cols-[1fr_120px]">
            <div className="relative">
              <img
                ...
                className={`h-96 w-full rounded-[24px] object-cover transition-transform ${zoom ? 'scale-105' : ''}`}
              />
            ...
            <div className="hidden flex-col gap-2 md:flex">
              ...
              <div className="mt-2 rounded-xl border border-white/10 p-2 text-sm text-slate-300">Video preview (placeholder)</div>
            </div>
          </div>

          <div className="mt-5 flex flex-wrap gap-3">
            <Link to="/customer/checkout" className="rounded-full bg-blue-600 px-5 py-2.5 text-sm font-medium text-white">Buy now</Link>
            <Link to="/customer/wishlist" className="rounded-full border border-white/10 px-5 py-2.5 text-sm font-medium text-slate-200">Add to wishlist</Link>
            <button className="rounded-full border border-white/10 px-5 py-2.5 text-sm font-medium text-slate-200">Compare</button>
          </div>
